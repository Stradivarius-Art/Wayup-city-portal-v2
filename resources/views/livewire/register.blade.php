...
<section class="main">
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form wire:submit.prevent='register' action="{{ route('register.store') }}">
                    <div class="mb-3">
                        <label for="emailRegisterField" class="form-label">E-mail</label>
                        <input type="text" name="email" wire:model='email' class="form-control" id="emailRegisterField" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" wire:model='name' class="form-control" id="fullNameField" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="passwordRegisterField" class="form-label">Пароль</label>
                        <input type="password" name="password" wire:model='password' class="form-control" id="passwordRegisterField">
                    </div>
                    <div class="mb-3">
                        <label for="passwordConfirmField" class="form-label">Подтверждение пароля</label>
                        <input type="password" name="password.confirmation" wire:model='password_confirmation' class="form-control" id="passwordConfirmField">
                    </div>
